...
function LOCAGAIN_RUNTIME() {
  ...
  function badgeHtml(payload, pal, pbHtml) {
    ...
    if (payload.style === 'framed') {
      ...
      var sep = b.showSeparator === false ? '' : '<span class="lcg-sep"></span>'
      var cntTxt = count + (c.lang === 'en' ? ' reviews' : ' avis')
      var cnt = b.showReviewCount ? sep + (sep ? cntTxt : '<span class="lcg-cnt-sp">' + cntTxt + '</span>') : ''
