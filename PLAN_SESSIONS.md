...
| G8 | Frontend — Configuration (wizard) | 🚧 En cours — sidebar anticipée + **G8.1 Étape Grille ✅** + **G8.2 Étapes Mots-clés/Planning ✅** (2026-07-02). Reste **G8.3** : Étape Concurrents (+ petit ajout backend `GET /competitors/detected`), récap, « premier rapport maintenant », édition pré-remplie. Voir `PROGRESS.md` Phase 11. |
