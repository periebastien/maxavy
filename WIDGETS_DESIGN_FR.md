...
| `containerPadding` | Marge extérieure (badge) / Marge intérieure (carrousel) | number | `16` | 0–64 (px) | espacement du conteneur — autour du badge (`.lcg-wrap`) / interne au carrousel (`.lcg-car`) |
